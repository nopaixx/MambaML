...
class BoxFactoryWizard extends React.Component {
	state = {
		code: '',
		dependencies: '',
...
const connectedAdminPage = connect(mapStateToProps)(BoxFactoryWizard);
export { connectedAdminPage as BoxFactoryWizard };
